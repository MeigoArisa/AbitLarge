...
namespace AbitLarge
{
    public class bithumbparsing : bithumbdata
    {
        private string m_sAPI_URL = "https://api.bithumb.com";

        internal JObject xcoinApiCall(string v, object sParams, ref string sRespBodyData)
        {
        ...
        public bithumbparsing(string sAPI_Key, string sAPI_Secret)
        {
